package com.anxiangban.activityshezhianquanqu;
...
public class SheZhiAnQuanQuActivity extends Activity {
	// 地图相关
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shezhianquanqu);
	...
	private GeoPoint[] getFormalOverlayData() {
		...
		if (biaozhi == 0) {
			Toast.makeText(SheZhiAnQuanQuActivity.this, "危险区未设定",
	...
	public void saveClick() {
		...
		case 1:
			...
			break;
		default:
			Toast.makeText(SheZhiAnQuanQuActivity.this, "未设置点",
					Toast.LENGTH_SHORT).show();
			break;
		}
	...
	MKMapTouchListener mapTouchListener = new MKMapTouchListener() {
		...
		public void onMapLongClick(GeoPoint point) {
			...
			if (pointsum < 10) {
				...
				Toast.makeText(SheZhiAnQuanQuActivity.this, "区域不能超过十个点",
						Toast.LENGTH_SHORT).show();
			}
		}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK
			...
			mMapView.getOverlays().clear();
			SheZhiAnQuanQuActivity.this.finish();
			return true;
		}
	...
	private void play(DefaultMessage message) {
		if (message.getFlag().equals(MessageType.MESSAGE_RETURN_OK)
				&& message.getContext().equals("OK")) {
			Toast.makeText(SheZhiAnQuanQuActivity.this, "设置成功",
					Toast.LENGTH_SHORT).show();
			InsertHelp insertHelp = new InsertHelp(app);
			insertHelp.SafeDangerInsert(safeData);
		} else if (message.getFlag().equals(MessageType.MESSAGE_RETURN_OK)
				&& message.getContext().equals("UN")) {
			Toast.makeText(SheZhiAnQuanQuActivity.this, "取消成功",
					Toast.LENGTH_SHORT).show();
		}
	}
}
