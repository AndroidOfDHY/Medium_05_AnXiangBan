...
import com.anxiangban.activityqrcode.CameraManager;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			 ...
			 * + 2, paint); canvas.drawRect(frame.left, frame.top + 2,
			 * frame.left + 2, frame.bottom - 1, paint);
			 * canvas.drawRect(frame.right - 1, frame.top, frame.right + 1,
			 * frame.bottom - 1, paint); canvas.drawRect(frame.left,
			 * frame.bottom - 1, frame.right + 1, frame.bottom + 1, paint);
			 */
